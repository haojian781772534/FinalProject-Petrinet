"""
This script is called by the plugin-wrapper, Visualizer.js, which passes down the
...
plugin = Visualizer(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
